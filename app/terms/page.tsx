        ...
        <section style={{ paddingTop: '120px', paddingBottom: '60px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="max-w-4xl mx-auto px-6" style={{ textAlign: 'center' }}>
            <div style={{
              ...
              background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)',
          ...
          <div className="max-w-3xl mx-auto px-6">
            <div style={{
              ...
              <div style={{
                ...
                <Link href="/privacy" style={{ color: '#C2CED2', textDecoration: 'none', fontSize: '14px', fontWeight: 500 }}>
                  Privacy Policy →
                </Link>
