      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-6" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>CAREERS</div>
            <h1 className="text-[52px] sm:text-[64px] font-black tracking-tight text-white leading-tight mb-5">
              Careers at<br />
              <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>NexFlow</span>
            </h1>
        ...
        <section className="pb-28 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-2xl mx-auto pt-12 space-y-6">
            ...
            <div className="rounded-2xl p-8" style={{ background: 'rgba(91,124,136,0.06)', border: '1px solid rgba(179,225,232,0.2)' }}>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="mailto:nexflowauto.ai@gmail.com" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-[14px] font-semibold text-white transition-all hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 4px 20px rgba(91,124,136,0.35)' }}>
                  Reach Out →
                </a>
