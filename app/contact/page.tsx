    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(91,124,136,0.12) 0%, transparent 70%)' }} />
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-6" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>GET IN TOUCH</div>
            <h1 className="text-[44px] sm:text-[62px] font-black tracking-tight text-white leading-tight mb-5">
              Let's Build Your<br />
              <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Automation System</span>
            </h1>
            ...
            <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
              ...
              <div style={{ position: 'relative', width: '100%', background: 'rgba(0,0,0,0.3)' }}>
                ...
                <div style={{
                  ...
                  background: 'linear-gradient(to top, rgba(19,19,19,0.35), transparent)'
                }} />
              </div>

              <div className="p-6">
                <h3 className="text-[22px] font-black text-white mb-1">Dinesh Kumar</h3>
                <p className="text-[13px] font-semibold mb-4" style={{ color: '#B3E1E8' }}>Founder &amp; CEO · NexFlow</p>
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="mailto:dineshdk7.official@gmail.com"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-medium text-[#B3E1E8] hover:text-[#8FBAC7] transition-colors"
                    style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>
                ...
                <a href="https://calendly.com/nexflowauto-ai/30min" target="_blank" rel="noopener"
                  ...
                  style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 4px 20px rgba(91,124,136,0.35)' }}>
            ...
            <div className="rounded-2xl p-8" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
              ...
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <button onClick={() => setSent(false)} className="mt-6 text-[13px] text-[#B3E1E8] hover:text-[#8FBAC7]">Send another</button>
                </div>
              ) : (
                <form ref={form} onSubmit={sendEmail} className="space-y-4">
                  {[
                    ...
                    <div key={field.name}>
                      ...
                      <input name={field.name} type={field.type} required={field.required}
                        ...
                        onFocus={e => (e.target as HTMLInputElement).style.borderColor = 'rgba(91,124,136,0.28)'}
                  ...
                  <div>
                    ...
                    <textarea name="message" required rows={5}
                      ...
                      style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}
                      onFocus={e => (e.target as HTMLTextAreaElement).style.borderColor = 'rgba(91,124,136,0.28)'}
                  ...
                  <button type="submit" disabled={loading}
                    ...
                    style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 4px 20px rgba(91,124,136,0.4)' }}>
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.06] space-y-3">
                <a href="mailto:dineshdk7.official@gmail.com" className="flex items-center gap-3 text-[13px] text-white/40 hover:text-white/70 transition-colors">
                  <span style={{ width: '32px', height: '32px', borderRadius: '10px', background: 'rgba(91,124,136,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg className="w-3.5 h-3.5 text-[#B3E1E8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                  </span>
