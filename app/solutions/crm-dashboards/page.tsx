      ...
      <main style={{ background: BG, minHeight: '100vh', color: '#fff' }}>
        ...
        <section className="relative pt-40 pb-28 px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(179,225,232,0.1)' }}>
              {/* Browser bar */}
              <div className="flex items-center gap-2 px-5 py-3 border-b" style={{ borderColor: 'rgba(179,225,232,0.08)', background: 'rgba(0,0,0,0.4)' }}>
              ...
              <div className="p-6">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  {/* Bar chart */}
                  <div className="sm:col-span-2 rounded-xl p-4" style={{ background: 'rgba(91,124,136,0.04)', border: '1px solid rgba(179,225,232,0.07)' }}>
                    ...
                    <div className="flex items-end gap-2 h-20">
                      {[55,72,48,85,60,90,75,88,65,95,82,100].map((h,i) => (
                        <div key={i} className="flex-1 rounded-sm" style={{ height:`${h}%`, background: i===11 ? `linear-gradient(to top,${G},${M})` : 'rgba(91,124,136,0.2)' }} />
                      ))}
                    </div>
                  ...
                  {/* Pipeline stages */}
                  <div className="rounded-xl p-4" style={{ background: 'rgba(91,124,136,0.04)', border: '1px solid rgba(179,225,232,0.07)' }}>
        ...
        <section className="py-24 px-6" style={{ borderTop: '1px solid rgba(179,225,232,0.08)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5 text-[11px] font-bold uppercase tracking-widest" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)', color: M }}>Capabilities</div>
