...
const solutions = [
  {
    ...
    accentColor: '#5B7C88',
    gradient: 'linear-gradient(135deg, rgba(91,124,136,0.12) 0%, rgba(91,124,136,0.08) 100%)',
    borderColor: 'rgba(91,124,136,0.15)',
  },
  {
  ...
  },
  {
    ...
    accentColor: '#7FA8B8',
    gradient: 'linear-gradient(135deg, rgba(127,168,184,0.1) 0%, rgba(91,124,136,0.06) 100%)',
    borderColor: 'rgba(127,168,184,0.2)',
  },
  {
    ...
    accentColor: '#C9A96A',
    gradient: 'linear-gradient(135deg, rgba(201,169,106,0.1) 0%, rgba(91,124,136,0.06) 100%)',
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section style={{ paddingTop: '130px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse, rgba(91,124,136,0.1) 0%, transparent 70%)',
            pointerEvents: 'none'
          }} />
          {/* Grid overlay */}
          <div style={{
          ...
          <div className="max-w-5xl mx-auto px-6 text-center" style={{ position: 'relative' }}>
            <div style={{
              ...
              background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(91,124,136,0.15)',
              fontSize: '12px', fontWeight: 600, color: '#B7C4D6', letterSpacing: '0.08em', textTransform: 'uppercase'
            }}>
              What We Build
            </div>
            <h1 style={{
              ...
              Solutions Built for{' '}
              <span style={{
                background: 'linear-gradient(135deg,#5B7C88,#8FBAC7,#7FA8B8)',
          ...
          <div className="max-w-7xl mx-auto px-6 pt-16">
            <Link href={solutions[0].href} style={{ display: 'block', textDecoration: 'none' }}>
              <div style={{
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-4px)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 24px 60px rgba(179,225,232,0.2)'; }}
              ...
              >
                ...
                <div style={{
                  ...
                  background: 'radial-gradient(circle, rgba(179,225,232,0.2) 0%, transparent 70%)',
                  pointerEvents: 'none'
                }} />
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '40px', alignItems: 'center' }}
                  ...
                  <div>
                    ...
                    <div style={{
                      ...
                      background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)',
                      boxShadow: '0 6px 24px rgba(91,124,136,0.4)'
                    }}>
              ...
              {[
                ...
                <div key={step.num} style={{
                  ...
                  <div style={{
                    ...
                    color: 'rgba(91,124,136,0.3)', marginBottom: '16px', textTransform: 'uppercase'
                  }}>{step.num}</div>
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="https://calendly.com/nexflowauto-ai/30min" target="_blank"
                style={{
                  ...
                  background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)',
                  boxShadow: '0 12px 40px rgba(91,124,136,0.4)'
                }}>
