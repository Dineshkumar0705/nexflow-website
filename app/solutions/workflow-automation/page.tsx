    ...
    <>
      ...
      <main style={{ background:'#131313', minHeight:'100vh' }}>
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background:'radial-gradient(ellipse 60% 50% at 50% 0%,rgba(91,124,136,0.15) 0%,transparent 70%)' }} />
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-violet-400 mb-6" style={{ background:'rgba(91,124,136,0.1)',border:'1px solid rgba(91,124,136,0.2)' }}>WORKFLOW AUTOMATION</div>
            <h1 className="text-[52px] sm:text-[68px] font-black tracking-tight text-white leading-tight mb-5">End-to-End<br /><span style={{ background:'linear-gradient(135deg,#B3E1E8,#8FBAC7)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',backgroundClip:'text' }}>Process Flow</span></h1>
