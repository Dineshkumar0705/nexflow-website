      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section style={{ paddingTop: '120px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
          <div style={{
            ...
            background: 'radial-gradient(circle, rgba(91,124,136,0.1) 0%, transparent 70%)',
            pointerEvents: 'none'
          }} />
          <div className="max-w-7xl mx-auto px-6">
            <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto' }}>
              <div style={{
                ...
                fontSize: '13px', fontWeight: 500, color: '#B7C4D6'
              }}>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#5B7C88', display: 'inline-block' }} />
                Lead Automation
              </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
              {features.map((f) => (
                <div key={f.title} style={{
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(91,124,136,0.35)'; (e.currentTarget as HTMLElement).style.background = 'rgba(91,124,136,0.06)'; }}
