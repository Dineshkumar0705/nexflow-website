...
export default function AIChatbotsPage() {
  ...
  return (
    <div style={{ backgroundColor: '#131313', color: 'white', minHeight: '100vh' }}>
      <Navbar />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div>
            <div style={{
              ...
              backgroundColor: 'rgba(91,124,136,0.15)',
            ...
            <h1 style={{
              ...
              <span style={{ background: 'linear-gradient(90deg, #B3E1E8 0%, #8FBAC7 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '40px' }}>
              <div>
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#B3E1E8', marginBottom: '8px' }}>500+</div>
                <div style={{ fontSize: '14px', color: '#A0A0A0' }}>Queries/day</div>
              </div>
              <div>
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#8FBAC7', marginBottom: '8px' }}>&lt;2s</div>
                <div style={{ fontSize: '14px', color: '#A0A0A0' }}>Response Time</div>
              </div>
              <div>
                <div style={{ fontSize: '32px', fontWeight: '700', color: '#5B7C88', marginBottom: '8px' }}>94%</div>
            ...
            <div style={{ display: 'flex', gap: '16px' }}>
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = '#8FBAC7';
                e.currentTarget.style.boxShadow = '0 12px 24px rgba(91,124,136,0.3)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = '#5B7C88';
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(143,186,199,0.1)';
              }}
              onMouseLeave={(e) => {
          ...
          {/* RIGHT: Chat Mockup */}
          <div style={{
            backgroundColor: 'rgba(91,124,136,0.08)',
            border: '1px solid rgba(143,186,199,0.2)',
            borderRadius: '16px',
            padding: '24px',
            ...
            <div style={{
              ...
              paddingBottom: '16px',
              borderBottom: '1px solid rgba(143,186,199,0.15)',
              marginBottom: '16px',
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '12px', color: '#B3E1E8' }}>Online</div>
                </div>
              </div>
            </div>
                ...
                >
                  <div style={{
                    ...
                    backgroundColor: msg.type === 'user'
                      ? 'rgba(179,225,232,0.15)'
                      : 'rgba(91,124,136,0.15)',
                    border: msg.type === 'user'
                      ? '1px solid #B3E1E8'
                      : '1px solid rgba(91,124,136,0.4)',
                    fontSize: '14px',
                    lineHeight: '1.4',
                  }}>
                    {msg.text}
            ...
            <div style={{
              ...
              gap: '8px',
              paddingTop: '12px',
              borderTop: '1px solid rgba(143,186,199,0.15)',
            }}>
              <input
                type="text"
                ...
                style={{
                  flex: 1,
                  backgroundColor: 'rgba(143,186,199,0.08)',
                  border: '1px solid rgba(143,186,199,0.2)',
                  borderRadius: '6px',
                  padding: '10px 12px',
                  color: 'white',
      ...
      {/* CHANNELS SECTION */}
      <section style={{ paddingTop: '80px', paddingBottom: '80px', paddingLeft: '40px', paddingRight: '40px', backgroundColor: 'rgba(91,124,136,0.05)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px' }}>
            {[
              ...
              <div
                ...
                style={{
                  backgroundColor: 'rgba(91,124,136,0.08)',
                  border: '1px solid rgba(143,186,199,0.15)',
                  borderRadius: '16px',
                  padding: '40px 32px',
                  backdropFilter: 'blur(10px)',
                  transition: 'all 0.3s ease',
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(91,124,136,0.12)';
                  e.currentTarget.style.borderColor = '#B3E1E8';
                  e.currentTarget.style.boxShadow = '0 20px 40px rgba(91,124,136,0.2)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(91,124,136,0.08)';
                  e.currentTarget.style.borderColor = 'rgba(143,186,199,0.15)';
                  e.currentTarget.style.boxShadow = 'none';
                }}
              >
                <div style={{
                ...
                <ul style={{ marginBottom: '24px' }}>
                  {channel.features.map((feat, j) => (
                    <li key={j} style={{ fontSize: '14px', color: '#D0D0D0', marginBottom: '8px', paddingLeft: '20px', position: 'relative' }}>
                      <span style={{ position: 'absolute', left: '0', color: '#B3E1E8' }}>✓</span>
                      {feat}
                    </li>
                  ))}
                </ul>
                <Link href="#" style={{ color: '#B3E1E8', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>
                  Learn more →
                </Link>
              </div>
            ))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
            {[
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  setHoveredFeature(i);
                  e.currentTarget.style.backgroundColor = 'rgba(91,124,136,0.15)';
                  e.currentTarget.style.borderColor = '#8FBAC7';
                  e.currentTarget.style.boxShadow = '0 15px 30px rgba(143,186,199,0.15)';
                }}
                onMouseLeave={(e) => {
              ...
              >
                <div style={{
                  ...
                  height: '48px',
                  borderRadius: '8px',
                  backgroundColor: 'rgba(91,124,136,0.2)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: '24px',
          ...
          <div style={{
            ...
            {['GPT-4', 'LangChain', 'OpenAI API', 'WhatsApp API', 'Python', 'FastAPI', 'Pinecone', 'Firebase', 'Webhooks', 'React Widget'].map((tech, i) => (
              <div
                key={i}
                style={{
                  backgroundColor: 'rgba(143,186,199,0.1)',
                  border: '1px solid rgba(143,186,199,0.3)',
                  borderRadius: '8px',
                  paddingLeft: '16px',
                  paddingRight: '16px',
                  paddingTop: '8px',
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(143,186,199,0.2)';
                  e.currentTarget.style.borderColor = '#B3E1E8';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(143,186,199,0.1)';
                  e.currentTarget.style.borderColor = 'rgba(143,186,199,0.3)';
                }}
              >
                {tech}
              </div>
      ...
      <section style={{
        ...
        paddingLeft: '40px',
        paddingRight: '40px',
        background: 'linear-gradient(135deg, rgba(91,124,136,0.15) 0%, rgba(143,186,199,0.1) 100%)',
        borderTop: '1px solid rgba(143,186,199,0.2)',
        borderBottom: '1px solid rgba(143,186,199,0.2)',
      }}>
