    ...
    <>
      ...
      <main style={{ background:'#131313', minHeight:'100vh' }}>
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background:'radial-gradient(ellipse 60% 50% at 50% 0%,rgba(127,168,184,0.12) 0%,transparent 70%)' }} />
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-cyan-400 mb-6" style={{ background:'rgba(127,168,184,0.1)',border:'1px solid rgba(127,168,184,0.2)' }}>CRM AUTOMATION</div>
            <h1 className="text-[52px] sm:text-[68px] font-black tracking-tight text-white leading-tight mb-5">Smarter<br /><span style={{ background:'linear-gradient(135deg,#B3E1E8,#5B7C88)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',backgroundClip:'text' }}>Customer Ops</span></h1>
