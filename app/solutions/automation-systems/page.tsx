      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section style={{ paddingTop: '120px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
          <div style={{
            ...
            background: 'radial-gradient(circle, rgba(91,124,136,0.12) 0%, transparent 70%)',
            pointerEvents: 'none'
          }} />
          <div className="max-w-7xl mx-auto px-6">
            <div style={{ textAlign: 'center', maxWidth: '780px', margin: '0 auto' }}>
              <div style={{
                ...
                background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(91,124,136,0.25)',
                fontSize: '13px', fontWeight: 500, color: '#C2CED2'
              }}>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#8FBAC7', display: 'inline-block' }} />
                Automation Systems
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <Link href="https://calendly.com/nexflowauto-ai/30min" target="_blank"
                  style={{
                    ...
                    boxShadow: '0 8px 32px rgba(91,124,136,0.35)'
                  }}>
                  Book a System Audit
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
              {features.map((f) => (
                <div key={f.title} style={{
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(91,124,136,0.35)'; (e.currentTarget as HTMLElement).style.background = 'rgba(91,124,136,0.05)'; }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px' }}>
              {deliverables.map((d, i) => (
                <div key={d.title} style={{
                  padding: '28px 24px',
                  borderRadius: '16px',
                  background: 'rgba(91,124,136,0.06)',
                  border: '1px solid rgba(91,124,136,0.12)',
