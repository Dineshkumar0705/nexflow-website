...
const workflow = [
  { step: '01', title: 'Order Placed', desc: 'Customer places order on any channel — website, WhatsApp, or marketplace. Webhook triggers instantly.', color: '#A9B4C2' },
  { step: '02', title: 'Inventory Check', desc: 'System auto-checks stock across warehouses, flags low inventory, and confirms availability in real-time.', color: '#7FA8B8' },
  { step: '03', title: 'Auto Invoice', desc: 'Invoice generated, payment link sent, and GST calculation completed — zero manual input required.', color: '#8FBAC7' },
  { step: '04', title: 'Fulfillment & Track', desc: 'Shipping partner assigned, label printed, and customer notified with live tracking link — automatically.', color: '#C9A96A' },
];
    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-36 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(169,180,194,0.1) 0%, transparent 65%)' }} />
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold mb-5" style={{ background: 'rgba(169,180,194,0.12)', border: '1px solid rgba(169,180,194,0.25)', color: '#A9B4C2' }}>CASE STUDY · WORKFLOW AUTOMATION</div>
            <h1 className="text-[48px] sm:text-[60px] font-black text-white tracking-tight leading-tight mb-4">
              E-commerce Order<br /><span style={{ background: 'linear-gradient(135deg,#A9B4C2,#A9B4C2)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Processing</span>
            </h1>
        ...
        <section className="py-16 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex px-4 py-1.5 rounded-full text-[11px] font-bold mb-3" style={{ background: 'rgba(169,180,194,0.1)', border: '1px solid rgba(169,180,194,0.2)', color: '#A9B4C2' }}>HOW IT WORKS</div>
        ...
        <section className="py-20 px-6 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/contact" className="inline-flex items-center gap-2 px-7 py-3 rounded-xl text-[14px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#5B7C88,#A9B4C2)', boxShadow: '0 8px 24px rgba(169,180,194,0.3)' }}>
