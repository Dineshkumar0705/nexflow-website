...
const workflow = [
  { step: '01', title: 'Query Received', desc: 'Customer sends a message via WhatsApp, email, or web chat. The system instantly detects intent and language.', color: '#C9A96A' },
  { step: '02', title: 'AI Classification', desc: 'OpenAI classifies the query by type — billing, technical, general, or complaint — and determines urgency level.', color: '#7FA8B8' },
  { step: '03', title: 'Auto-Resolution', desc: 'For 80% of queries, the AI drafts and sends a resolution instantly using your knowledge base and past tickets.', color: '#8FBAC7' },
  { step: '04', title: 'Smart Escalation', desc: 'Complex or high-priority queries are routed to the right human agent with full context and suggested response.', color: '#A9B4C2' },
];
    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-36 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(201,169,106,0.1) 0%, transparent 65%)' }} />
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold mb-5" style={{ background: 'rgba(201,169,106,0.12)', border: '1px solid rgba(201,169,106,0.25)', color: '#C9A96A' }}>CASE STUDY · AI AUTOMATION</div>
            <h1 className="text-[48px] sm:text-[60px] font-black text-white tracking-tight leading-tight mb-4">
              AI Customer<br />Support <span style={{ background: 'linear-gradient(135deg,#C9A96A,#C9A96A)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Automation</span>
            </h1>
        ...
        <section className="py-16 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex px-4 py-1.5 rounded-full text-[11px] font-bold text-[#C9A96A] mb-3" style={{ background: 'rgba(201,169,106,0.1)', border: '1px solid rgba(201,169,106,0.2)' }}>HOW IT WORKS</div>
        ...
        <section className="py-20 px-6 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/contact" className="inline-flex items-center gap-2 px-7 py-3 rounded-xl text-[14px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#6E767A,#C9A96A)', boxShadow: '0 8px 24px rgba(201,169,106,0.3)' }}>
