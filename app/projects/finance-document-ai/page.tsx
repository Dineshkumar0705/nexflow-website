...
const capabilities = [
  { icon: '📋', title: 'Invoice Processing', desc: 'Auto-extract vendor, amount, GST, line items, and due date from any invoice format — PDF, image, or scan.', color: '#7FA8B8' },
  { icon: '📊', title: 'Financial Report Analysis', desc: 'Parse P&L statements, balance sheets, and MIS reports. Extract key metrics and flag anomalies instantly.', color: '#8FBAC7' },
  { icon: '📝', title: 'Contract Extraction', desc: 'Identify parties, payment terms, renewal dates, and clauses from legal and commercial contracts.', color: '#A9B4C2' },
  { icon: '🏦', title: 'Bank Statement Parsing', desc: 'Auto-categorise transactions, detect duplicates, and reconcile with internal ledger entries automatically.', color: '#C9A96A' },
  { icon: '🔍', title: 'Fraud Detection', desc: 'AI-powered anomaly detection on document metadata, amounts, and patterns — flags suspicious entries in real-time.', color: '#C98A8A' },
  { icon: '📤', title: 'Auto Ledger Entry', desc: 'Extracted data maps directly to accounting system fields — Tally, Zoho Books, or custom ERP — zero re-entry.', color: '#5B7C88' },
];
    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-36 pb-20 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(127,168,184,0.1) 0%, transparent 65%)' }} />
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold mb-5" style={{ background: 'rgba(127,168,184,0.12)', border: '1px solid rgba(127,168,184,0.25)', color: '#B3E1E8' }}>CASE STUDY · AI + DOCUMENT PROCESSING</div>
            <h1 className="text-[48px] sm:text-[60px] font-black text-white tracking-tight leading-tight mb-4">
              Finance Document<br /><span style={{ background: 'linear-gradient(135deg,#B3E1E8,#7FA8B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>AI Processing</span>
            </h1>
        ...
        <section className="py-16 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex px-4 py-1.5 rounded-full text-[11px] font-bold mb-3" style={{ background: 'rgba(127,168,184,0.1)', border: '1px solid rgba(127,168,184,0.2)', color: '#B3E1E8' }}>CAPABILITIES</div>
        ...
        <section className="py-20 px-6 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/contact" className="inline-flex items-center gap-2 px-7 py-3 rounded-xl text-[14px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#5B7C88,#B3E1E8)', boxShadow: '0 8px 24px rgba(127,168,184,0.3)' }}>
