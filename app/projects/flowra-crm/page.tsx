...
const integrations = [
  { name: 'WhatsApp Business', desc: '1,284 messages sent today. Automated follow-ups, template messages, and read receipts — directly from your CRM pipeline.', stat: '98.2% Open Rate', color: '#8FBAC7', icon: '💬' },
  { name: 'Gmail', desc: '4,730 emails synced. Two-way email sync, automated sequences, inbox-to-CRM contact capture and thread tracking.', stat: '42.1% Open Rate', color: '#C98A8A', icon: '✉️' },
  { name: 'Google Calendar', desc: '312 events synchronized. Meeting scheduling, auto-create deal touchpoints, and team availability management.', stat: '47 Meetings', color: '#7FA8B8', icon: '📅' },
  { name: 'Autopilot AI', desc: '24 automations live. Stale deal alerts, AI lead scoring, smart routing, and re-engagement flows — hands-free.', stat: '18h/wk Saved', color: '#A9B4C2', icon: '🤖' },
  { name: 'Razorpay', desc: '₹38.4L revenue tracked. Payment tracking, invoice generation, subscription sync, and refund handling built-in.', stat: '97.8% Success Rate', color: '#7FA8B8', icon: '💳' },
  { name: 'In-App Notifications', desc: '143 alerts sent today. Instant alerts, custom rules, push notifications and digest emails for every deal move.', stat: '91.4% Read Rate', color: '#C9A96A', icon: '🔔' },
];
...
const topPerformers = [
  { rank: '🥇', name: 'Arjun Sharma', deals: 14, revenue: '₹42.0L', winRate: '74%', color: '#C9A96A' },
  { rank: '🥈', name: 'Priya Nair', deals: 11, revenue: '₹33.0L', winRate: '68%', color: '#9ca3af' },
  { rank: '🥉', name: 'Vikram Singh', deals: 9, revenue: '₹27.0L', winRate: '56%', color: '#8A9296' },
...
export default function FlowraCRMPage() {
  ...
  return (
    <>
      <Navbar />
      <main style={{ background: '#131313', minHeight: '100vh' }}>

        {/* ─── Hero ─── */}
        <section className="relative pt-36 pb-24 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 70% 55% at 50% 0%, rgba(91,124,136,0.14) 0%, transparent 65%)' }} />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="flex items-center gap-3 mb-5">
                  <span className="px-3 py-1 rounded-full text-[11px] font-bold tracking-wider text-[#B3E1E8]" style={{ background: 'rgba(91,124,136,0.15)', border: '1px solid rgba(179,225,232,0.25)' }}>
                    LIVE PRODUCT
                  </span>
                ...
                <h1 className="text-[52px] sm:text-[64px] font-black tracking-tight text-white leading-[1.05] mb-4">
                  Flowra<br />
                  <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>CRM</span>
                </h1>
                ...
                <div className="flex gap-3">
                  <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-[14px] font-bold text-white transition-all hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 8px 24px rgba(91,124,136,0.4)' }}>
              ...
              <div className="rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                {[
                  { label: 'WhatsApp Messages Sent', value: '1,284/day', color: '#8FBAC7', pct: 98 },
                  { label: 'Gmail Emails Synced', value: '4,730 total', color: '#C98A8A', pct: 85 },
                  { label: 'Calendar Events', value: '312 synced', color: '#7FA8B8', pct: 70 },
                  { label: 'Deals Auto-Revived', value: '37 this month', color: '#A9B4C2', pct: 78 },
                  { label: 'Revenue Tracked', value: '₹38.4L', color: '#5B7C88', pct: 92 },
                  { label: 'Notification Alerts', value: '143 sent today', color: '#C9A96A', pct: 65 },
                ].map(m => (
        ...
        <section className="py-16 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold text-[#B3E1E8] mb-3" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>PRODUCT SCREENSHOTS</div>
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-6">
              {screenshots.map((s, i) => (
                <button
                  ...
                  style={{
                    background: activeScreen === i ? 'rgba(91,124,136,0.25)' : 'rgba(255,255,255,0.05)',
                    border: activeScreen === i ? '1px solid rgba(179,225,232,0.35)' : '1px solid rgba(255,255,255,0.08)',
                    color: activeScreen === i ? '#B3E1E8' : 'rgba(255,255,255,0.4)',
                  }}
                >
                  {s.label}
                </button>
            ...
            <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 32px 80px rgba(0,0,0,0.6)' }}>
              ...
              {/* Screen area */}
              <div className="relative w-full" style={{ aspectRatio: '16/9', background: 'rgba(19,19,19,0.35)' }}>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center" style={{ background: 'rgba(19,19,19,0.3)' }}>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold text-[#B3E1E8] mb-3" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>FEATURES</div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold text-[#B3E1E8] mb-3" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>INTEGRATIONS</div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold text-[#B3E1E8] mb-3" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>ANALYTICS</div>
              ...
              {topPerformers.map((p, i) => (
                <div key={i} className="grid grid-cols-4 px-6 py-5 items-center transition-all hover:bg-white/[0.02]" style={{ borderBottom: i < topPerformers.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none' }}>
                  ...
                  <div className="flex justify-end">
                    <span className="px-2.5 py-1 rounded-lg text-[13px] font-bold" style={{ background: i === 0 ? 'rgba(143,186,199,0.15)' : i === 1 ? 'rgba(91,124,136,0.15)' : 'rgba(255,255,255,0.05)', color: i === 0 ? '#8FBAC7' : i === 1 ? '#B3E1E8' : '#C9A96A' }}>
                      {p.winRate}
                    </span>
                  </div>
                </div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold text-[#B3E1E8] mb-3" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>TECH STACK</div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {techStack.map((layer, i) => (
                <div key={i} className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
                  <div className="text-[11px] font-bold tracking-widest text-[#B3E1E8] uppercase mb-3">{layer.label}</div>
                  <div className="flex flex-col gap-2">
                    {layer.items.map(item => (
                      <span key={item} className="text-[13px] text-white/60 font-medium flex items-center gap-2">
                        <span style={{ color: '#5B7C88' }}>▸</span> {item}
                      </span>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {['OAuth 2.0 Auth', 'AES-256 Encryption', 'GDPR Compliant', 'API Rate Limiting', 'Audit Logs', 'Data Residency (India)', 'ISO 27001 Certified'].map(b => (
                  <span key={b} className="flex items-center gap-1.5 text-[12px] text-white/40">
                    <span className="text-[#5B7C88] text-[14px]">✓</span> {b}
                  </span>
                ))}
              </div>
            </div>
        ...
        <section className="py-24 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-3xl mx-auto rounded-3xl p-12 text-center relative overflow-hidden" style={{ background: 'rgba(91,124,136,0.08)', border: '1px solid rgba(179,225,232,0.15)' }}>
            <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(91,124,136,0.1) 0%, transparent 70%)' }} />
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-[15px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 8px 32px rgba(91,124,136,0.28)' }}>
                  Build My CRM →
                </Link>
