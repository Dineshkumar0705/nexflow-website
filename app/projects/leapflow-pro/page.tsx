    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-36 pb-24 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 70% 55% at 50% 0%, rgba(127,168,184,0.1) 0%, transparent 65%)' }} />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-5">
                  <span className="px-3 py-1 rounded-full text-[11px] font-bold tracking-wider" style={{ background: 'rgba(127,168,184,0.12)', border: '1px solid rgba(179,225,232,0.25)', color: '#B3E1E8' }}>
                    MOBILE APP
                  </span>
                ...
                <h1 className="text-[52px] sm:text-[64px] font-black tracking-tight text-white leading-[1.05] mb-4">
                  LeapFlow<br />
                  <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#7FA8B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Pro</span>
                </h1>

                <p className="text-[18px] font-medium mb-2" style={{ color: '#B3E1E8' }}>Lead management & analytics in your pocket</p>
                ...
                <div className="flex gap-3 flex-wrap">
                  <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-[14px] font-bold text-white transition-all hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg,#5B7C88,#B3E1E8)', boxShadow: '0 8px 24px rgba(127,168,184,0.35)' }}>
                    Build Similar App →
                  </Link>
              ...
              <div className="flex justify-center items-center relative">
                <div className="relative">
                  {/* Glow */}
                  <div className="absolute inset-0 rounded-full blur-3xl opacity-30" style={{ background: 'radial-gradient(circle, rgba(127,168,184,0.4), transparent)' }} />
                  {/* Primary phone */}
                  <div className="relative z-10 w-[240px] rounded-[40px] overflow-hidden mx-auto" style={{ border: '2px solid rgba(179,225,232,0.2)', boxShadow: '0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.05)', background: '#161616' }}>
                    {/* Status bar */}
                    ...
                    {/* App header */}
                    <div className="px-4 py-3" style={{ background: 'rgba(127,168,184,0.08)' }}>
                    ...
                    {/* Mock lead cards */}
                    {[
                      { name: 'Arjun Sharma', company: 'Tata Consultancy', score: 94, status: 'Hot', color: '#8FBAC7' },
                      { name: 'Priya Nair', company: 'Infosys', score: 87, status: 'Warm', color: '#C9A96A' },
                      { name: 'Vikram Singh', company: 'HDFC Bank', score: 72, status: 'New', color: '#7FA8B8' },
                      { name: 'Ananya Rao', company: 'Reliance Jio', score: 68, status: 'New', color: '#7FA8B8' },
                    ].map((lead, i) => (
        ...
        <section className="py-16 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold mb-3" style={{ background: 'rgba(127,168,184,0.1)', border: '1px solid rgba(179,225,232,0.2)', color: '#B3E1E8' }}>APP SCREENS</div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 justify-center">
              {screens.map((s, i) => (
                <div key={i} className="flex-shrink-0 w-[160px]">
                  <div className="rounded-[28px] overflow-hidden mb-3 relative" style={{ border: '1.5px solid rgba(179,225,232,0.15)', boxShadow: '0 16px 40px rgba(0,0,0,0.6)', aspectRatio: '9/19', background: '#181818' }}>
                    <Image
                      src={s.file}
                      alt={s.label}
                      fill
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold mb-3" style={{ background: 'rgba(127,168,184,0.1)', border: '1px solid rgba(179,225,232,0.2)', color: '#B3E1E8' }}>FEATURES</div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold mb-3" style={{ background: 'rgba(127,168,184,0.1)', border: '1px solid rgba(179,225,232,0.2)', color: '#B3E1E8' }}>TECH STACK</div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {techStack.map((layer, i) => (
                <div key={i} className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
                  <div className="text-[11px] font-bold tracking-widest mb-3" style={{ color: '#B3E1E8' }}>{layer.label.toUpperCase()}</div>
                  <div className="flex flex-col gap-2">
                    {layer.items.map(item => (
                      <span key={item} className="text-[13px] text-white/60 font-medium flex items-center gap-2">
                        <span style={{ color: '#7FA8B8' }}>▸</span> {item}
                      </span>
                    ))}
                  </div>
                </div>
        ...
        <section className="py-24 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-3xl mx-auto rounded-3xl p-12 text-center relative overflow-hidden" style={{ background: 'rgba(127,168,184,0.07)', border: '1px solid rgba(179,225,232,0.15)' }}>
            <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(127,168,184,0.08) 0%, transparent 70%)' }} />
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-[15px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#5B7C88,#B3E1E8)', boxShadow: '0 8px 32px rgba(127,168,184,0.35)' }}>
                  Build My App →
                </Link>
