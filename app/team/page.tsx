      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-6" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>THE TEAM</div>
            <h1 className="text-[52px] sm:text-[64px] font-black tracking-tight text-white leading-tight mb-5">
              Meet the People<br />
              <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Behind NexFlow</span>
            </h1>
            ...
            {team.map((member, i) => (
              <div key={i} className="w-full max-w-sm rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-[13px] font-semibold mb-4" style={{ color: '#B3E1E8' }}>{member.role}</p>
                  ...
                  <div className="flex justify-center gap-3">
                    {[
                      ...
                      <a key={s.label} href={s.href} target="_blank" rel="noopener" className="px-3 py-1.5 rounded-lg text-[12px] font-medium text-[#B3E1E8] hover:text-[#B3E1E8] transition-colors" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>
                        {s.label}
                      </a>
                    ))}
                  </div>
