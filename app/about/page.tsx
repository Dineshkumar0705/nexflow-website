    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section className="relative pt-40 pb-24 px-6 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 70% 50% at 50% 0%, rgba(91,124,136,0.12) 0%, transparent 70%)' }} />
          <div className="absolute inset-0 grid-overlay opacity-30 pointer-events-none" />
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-6" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>ABOUT NEXFLOW</div>
            <h1 className="text-[52px] sm:text-[68px] font-black tracking-tight text-white leading-tight mb-6">
              Building the Future of<br />
              <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Business Automation</span>
            </h1>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-5" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>WHAT WE DO</div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {services.map((item, i) => (
                <div key={i} className="flex items-center gap-3 rounded-xl px-5 py-4 transition-all duration-200 hover:border-[rgba(179,225,232,0.3)]" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.06)' }}>
                  <div className="w-2 h-2 rounded-full bg-[#5B7C88] flex-shrink-0" />
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-5" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>OUR APPROACH</div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-5" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>INDUSTRIES</div>
        ...
        <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-semibold text-[#B3E1E8] mb-5" style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.2)' }}>FOUNDER</div>
            ...
            <div className="max-w-3xl mx-auto rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)' }}>
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-8 flex flex-col justify-center">
                  ...
                  <p className="text-[14px] font-semibold mb-4" style={{ color: '#B3E1E8' }}>Founder · NexFlow</p>
                  ...
                  <div className="flex gap-4 mb-6">
                    <a href="mailto:dineshdk7.official@gmail.com" className="text-[13px] text-[#B3E1E8] hover:text-[#8FBAC7] transition-colors">Email</a>
                    <a href="https://www.linkedin.com/in/denu0705/" target="_blank" rel="noopener" className="text-[13px] text-[#B3E1E8] hover:text-[#8FBAC7] transition-colors">LinkedIn</a>
                    <a href="https://www.instagram.com/dinesh_kumaroff7" target="_blank" rel="noopener" className="text-[13px] text-[#B3E1E8] hover:text-[#8FBAC7] transition-colors">Instagram</a>
                  </div>
                  <button onClick={openCalendly} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-[14px] font-semibold text-white w-fit transition-all hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 4px 20px rgba(91,124,136,0.35)' }}>
                    Book a Call
                  </button>
                </div>
              </div>
        ...
        <section className="py-24 px-6 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <button onClick={openCalendly} className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-[16px] font-bold text-white transition-all hover:-translate-y-1" style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 8px 32px rgba(91,124,136,0.28)' }}>
            Book Demo
