...
const industries = [
  {
    ...
    accentColor: '#7FA8B8',
    gradient: 'linear-gradient(135deg, rgba(127,168,184,0.12) 0%, rgba(127,168,184,0.06) 100%)',
    borderColor: 'rgba(127,168,184,0.2)',
  },
  {
    ...
    accentColor: '#C9A96A',
    gradient: 'linear-gradient(135deg, rgba(201,169,106,0.12) 0%, rgba(201,138,138,0.06) 100%)',
  ...
  },
  {
    ...
    accentColor: '#5B7C88',
    gradient: 'linear-gradient(135deg, rgba(91,124,136,0.1) 0%, rgba(91,124,136,0.06) 100%)',
    borderColor: 'rgba(179,225,232,0.2)',
  },
  {
    ...
    accentColor: '#8FBAC7',
    gradient: 'linear-gradient(135deg, rgba(91,124,136,0.12) 0%, rgba(91,124,136,0.06) 100%)',
    borderColor: 'rgba(179,225,232,0.2)',
  },
  {
    ...
    accentColor: '#7FA8B8',
    gradient: 'linear-gradient(135deg, rgba(127,168,184,0.12) 0%, rgba(91,124,136,0.06) 100%)',
    borderColor: 'rgba(127,168,184,0.2)',
  },
  {
    ...
    accentColor: '#C2A9B8',
    gradient: 'linear-gradient(135deg, rgba(194,169,184,0.1) 0%, rgba(91,124,136,0.06) 100%)',
    borderColor: 'rgba(194,169,184,0.2)',
  },
];
    ...
    <>
      ...
      <main style={{ background: '#131313', minHeight: '100vh' }}>
        ...
        <section style={{ paddingTop: '130px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: '-10%', left: '50%', transform: 'translateX(-50%)', width: '900px', height: '600px', background: 'radial-gradient(ellipse, rgba(91,124,136,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
          ...
          <div className="max-w-5xl mx-auto px-6 text-center" style={{ position: 'relative' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '6px 18px', borderRadius: '100px', marginBottom: '28px', background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(91,124,136,0.15)', fontSize: '12px', fontWeight: 600, color: '#B7C4D6', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              Industries We Serve
            </div>
            <h1 style={{ fontSize: 'clamp(40px, 6vw, 68px)', fontWeight: 900, lineHeight: 1.05, color: '#fff', marginBottom: '24px', letterSpacing: '-0.02em' }}>
              ...
              <span style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7,#7FA8B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                Your Industry
              </span>
            </h1>
        ...
        <section style={{ paddingTop: '80px', paddingBottom: '100px', borderTop: '1px solid rgba(255,255,255,0.05)', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: '600px', height: '400px', background: 'radial-gradient(ellipse, rgba(91,124,136,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
          <div className="max-w-3xl mx-auto px-6" style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="https://calendly.com/nexflowauto-ai/30min" target="_blank"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '16px 36px', borderRadius: '14px', fontWeight: 700, fontSize: '16px', color: '#fff', textDecoration: 'none', background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)', boxShadow: '0 12px 40px rgba(91,124,136,0.4)' }}>
