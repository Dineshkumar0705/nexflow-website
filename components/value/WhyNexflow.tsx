      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="text-[40px] sm:text-[52px] font-black tracking-tight text-white mb-4 leading-tight">
            Built different.<br />
            <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Delivers differently.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLDivElement).style.background = `rgba(${f.color === '#5B7C88' ? '99,102,241' : f.color === '#8FBAC7' ? '139,92,246' : f.color === '#7FA8B8' ? '6,182,212' : f.color === '#7FA8B8' ? '16,185,129' : f.color === '#C9A96A' ? '245,158,11' : '236,72,153'},0.06)`;
