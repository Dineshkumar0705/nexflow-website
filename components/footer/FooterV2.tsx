...
export default function FooterV2() {
  return (
    <footer className="relative overflow-hidden" style={{ background: '#131313', borderTop: '1px solid rgba(179,225,232,0.07)' }}>

      {/* Top accent line */}
      <div className="absolute top-0 left-0 right-0 h-px"
        style={{ background: 'linear-gradient(90deg,transparent,rgba(179,225,232,0.35),transparent)' }} />

      {/* BG glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] rounded-full pointer-events-none opacity-10"
        style={{ background: 'radial-gradient(ellipse, rgba(91,124,136,0.3) 0%, transparent 70%)', filter: 'blur(60px)' }} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 pb-12 border-b border-white/[0.05]">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-6 w-fit">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center"
                style={{ background: 'linear-gradient(135deg,#5B7C88,#8FBAC7)' }}>
              ...
              <div>
                <span className="text-[18px] font-bold text-white tracking-tight">
                  Nex<span style={{ background:'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Flow</span>
                </span>
            ...
            <div className="space-y-3 mb-6">
              <a href="mailto:nexflowauto.ai@gmail.com" className="flex items-center gap-2.5 text-[13px] text-white/40 hover:text-[#B3E1E8] transition-colors group">
                <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(91,124,136,0.1)', border: '1px solid rgba(179,225,232,0.1)' }}>
                  <svg className="w-3.5 h-3.5" style={{ color: '#B3E1E8' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            ...
            <div className="flex gap-2.5">
              <a href="https://www.linkedin.com/in/denu0705/" target="_blank" rel="noopener" aria-label="LinkedIn"
                ...
                style={{ background: 'rgba(91,124,136,0.08)', border: '1px solid rgba(179,225,232,0.1)' }}>
                <svg className="w-4 h-4" style={{ color: 'rgba(179,225,232,0.3)' }} fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:nexflowauto.ai@gmail.com" aria-label="Email"
                className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5"
                style={{ background: 'rgba(91,124,136,0.08)', border: '1px solid rgba(179,225,232,0.1)' }}>
                <svg className="w-4 h-4" style={{ color: 'rgba(179,225,232,0.3)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
              </a>
            </div>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category} className="lg:col-span-1">
              <div className="text-[11px] font-bold tracking-widest uppercase mb-5" style={{ color: 'rgba(179,225,232,0.4)' }}>{category}</div>
          ...
          <div className="lg:col-span-1">
            <div className="text-[11px] font-bold tracking-widest uppercase mb-5" style={{ color: 'rgba(179,225,232,0.4)' }}>Tech Stack</div>
            <div className="flex flex-wrap gap-2">
              {techStack.map((tech, i) => (
                <span key={i} className="text-[12px] px-2.5 py-1 rounded-lg"
                  style={{ background: 'rgba(91,124,136,0.08)', border: '1px solid rgba(179,225,232,0.1)', color: 'rgba(179,225,232,0.3)' }}>
                  {tech}
                </span>
              ))}
            </div>
            <div className="mt-6 p-4 rounded-xl" style={{ background: 'rgba(91,124,136,0.06)', border: '1px solid rgba(179,225,232,0.1)' }}>
