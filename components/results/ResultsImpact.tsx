  ...
  return (
    <section ref={sectionRef} className="relative py-28 overflow-hidden" style={{ background: '#131313' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-20" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(179,225,232,0.25) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        {/* Social proof bar */}
        <div className="mt-20 p-8 rounded-2xl text-center" style={{ background: 'rgba(91,124,136,0.06)', border: '1px solid rgba(91,124,136,0.12)' }}>
