...
const avatarColors = ['#5B7C88','#8FBAC7','#7FA8B8','#7FA8B8','#C9A96A','#C2A9B8'];
  ...
  return (
    <section ref={sectionRef} className="relative py-28 overflow-hidden" style={{ background: '#161616' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] opacity-10" style={{ background: 'radial-gradient(ellipse, rgba(91,124,136,0.3) 0%, transparent 70%)', filter: 'blur(60px)' }} />
      </div>
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-14 reveal">
          ...
          <h2 className="text-[40px] sm:text-[52px] font-black tracking-tight text-white mb-4">
            ...
            <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>move fast.</span>
          </h2>
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-5">
          {testimonials.map((t, i) => (
            <div key={i} className="reveal break-inside-avoid mb-5 rounded-2xl p-6 transition-all duration-300 cursor-default"
              ...
              onMouseEnter={(e) => { const el = e.currentTarget as HTMLDivElement; el.style.background='rgba(91,124,136,0.06)'; el.style.borderColor='rgba(179,225,232,0.2)'; el.style.transform='translateY(-3px)'; }}
