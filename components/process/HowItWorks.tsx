...
export default function HowItWorks() {
  ...
  return (
    <section ref={sectionRef} className="relative py-28 overflow-hidden" style={{ background: '#161616' }}>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="text-[40px] sm:text-[52px] font-black tracking-tight text-white mb-4">
            From zero to{' '}
            <span style={{ background: 'linear-gradient(135deg,#B3E1E8,#5B7C88)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>automated</span>
            <br />in 4 steps.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div className="absolute top-12 left-[12.5%] right-[12.5%] h-px hidden lg:block" style={{ background: 'linear-gradient(90deg,rgba(179,225,232,0.25),rgba(91,124,136,0.3),rgba(127,168,184,0.3),rgba(127,168,184,0.3))' }} />
          ...
          {steps.map((step, i) => (
            <div key={i} className="reveal relative group" style={{ animationDelay: `${i*100}ms` }}>
              <div className="relative rounded-2xl p-6 h-full transition-all duration-300 hover:-translate-y-2"
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background='rgba(91,124,136,0.06)'; (e.currentTarget as HTMLDivElement).style.borderColor='rgba(91,124,136,0.15)'; (e.currentTarget as HTMLDivElement).style.boxShadow='0 20px 60px rgba(91,124,136,0.1)'; }}
              ...
              >
                {/* Step number badge */}
                <div className="relative z-10 w-12 h-12 rounded-2xl flex items-center justify-center mb-5 text-[#B3E1E8]" style={{ background: 'rgba(91,124,136,0.12)', border: '1px solid rgba(179,225,232,0.2)' }}>
                  {step.icon}
                </div>
